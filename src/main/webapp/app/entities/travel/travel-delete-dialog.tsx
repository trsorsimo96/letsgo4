...
export class TravelDeleteDialog extends React.Component<ITravelDeleteDialogProps> {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="letsgoApp.travel.delete.question">
          <Translate contentKey="letsgoApp.travel.delete.question" interpolate={{ id: travelEntity.id }}>
