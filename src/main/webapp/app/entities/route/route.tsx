...
export class Route extends React.Component<IRouteProps, IRouteState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="route-heading">
          <Translate contentKey="letsgoApp.route.home.title">Routes</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="letsgoApp.route.home.createLabel">Create new Route</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('letsgoApp.route.home.search')}
                  />
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="letsgoApp.route.title">Title</Translate>
                </th>
                <th />
              </tr>
            </thead>
