    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="letsgoApp.route.home.createOrEditLabel">
              <Translate contentKey="letsgoApp.route.home.createOrEditLabel">Create or edit a Route</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : routeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="route-title" type="text" name="title" />
                </AvGroup>
