    ...
    return (
      <div>
        <h2 id="partner-heading">
          <Translate contentKey="letsgoApp.partner.home.title">Partners</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="letsgoApp.partner.home.createLabel">Create new Partner</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('letsgoApp.partner.home.search')}
                  />
            ...
            <tbody>
              {partnerList.map((partner, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{partner.name}</td>
                  <td>{partner.solde}</td>
                  <td>{partner.distributor ? <Link to={`distributor/${partner.distributor.id}`}>{partner.distributor.id}</Link> : ''}</td>
